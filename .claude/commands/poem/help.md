...
| Command | Description |
|---------|-------------|
| `/poem/agents/penny` | Activate the Prompt Engineer agent (Petra) for creating, refining, testing, and validating AI prompts |
...
3. Activate an agent: `/poem/agents/penny`
